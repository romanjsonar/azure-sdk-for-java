...
public class ServersInner implements InnerSupportsGet<ServerInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ServerInner> {
    ...
    interface ServersService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.sql.Servers getAuditingPolicy" })
        @GET("subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/auditingPolicies/{policyName}")
        Observable<Response<ResponseBody>> getAuditingPolicy(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("serverName") String serverName, @Path("policyName") String policyName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    }
    ...
    private ServiceResponse<ServerFirewallRuleInner> createOrUpdateFirewallRuleDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ServerFirewallRuleInner, CloudException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<PageImpl<ServerFirewallRuleInner>> listFirewallRulesDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<ServerFirewallRuleInner>, CloudException>newInstance(this.client.serializerAdapter())
     ...
     */
    public AuditingPolicyInner getAuditingPolicy(String resourceGroupName, String serverName) {
        return getAuditingPolicyResponseAsync(resourceGroupName, serverName).toBlocking().single().body();
    }
     ...
     */
    public Observable<AuditingPolicyInner> getAuditingPolicyAsync(String resourceGroupName, String serverName) {
        return getAuditingPolicyResponseAsync(resourceGroupName, serverName).map(new Func1<ServiceResponse<AuditingPolicyInner>, AuditingPolicyInner>() {
            @Override
     ...
     * @return the observable to the ServiceTierAdvisorInner object
     */
    public Observable<ServiceResponse<AuditingPolicyInner>> getAuditingPolicyResponseAsync(String resourceGroupName, String serverName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        return service.getAuditingPolicy(this.client.subscriptionId(), resourceGroupName, serverName, auditingPolicyName, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
